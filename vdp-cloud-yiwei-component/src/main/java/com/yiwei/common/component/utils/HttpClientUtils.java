    	    ...
    	    fixedThreadPool.execute(new Runnable() {
    	        ...
    	        public void run() {
    	            try {
    	                ...
    	                Thread.sleep(100);
    	                String result = sendHttpGet("http://api.map.baidu.com/reverse_geocoding/v3/?ak=frIh8G0ePIZAq0wURjFLWBpIZnt20ZFf&location=30.452185574141,114.40305305014&coordtype=bd09ll&output=json&pois=1");
